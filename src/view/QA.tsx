import { Bulb2 } from '@/svgs'
import { useState } from 'react'

const tabs = [
  { key: 'common', label: '常見問答.html' },
  { key: 'ui', label: 'UI 設計師常見問題.html' },
  { key: 'frontend', label: '前端工程師常見問題.html' },
  { key: 'team', label: '團體組常見問題.html' }
]
...
export default function QA() {
  ...
  return (
    <div className='the-f2e-qa-section'>
      <div className='the-f2e-qa-container'>
        <div className='the-f2e-qa-header'>
          <h3 className='the-f2e-qa-header-title'>常見問題</h3>
        </div>
        <div className='the-f2e-qa-body'>
          <div className='the-f2e-qa-body-tabs'>
            {tabs.map((tab) => (
              <div
                className={`the-f2e-qa-body-tab ${tab.key === currentTab ? 'active' : ''}`}
                key={tab.key}
          ...
          <div className='the-f2e-qa-body-tab-content'>
            <ul className='the-f2e-qa-body-tab-content-list'>
              {data[currentTab].map((d: any) => (
                <li className='the-f2e-qa-body-tab-content-list-item' key={d.question}>
                  <h4 className='the-f2e-qa-body-tab-content-question'>{d.question}</h4>
                  <p className='the-f2e-qa-body-tab-content-answer'>{d.answer}</p>
                </li>
              ))}
            </ul>
          </div>
        </div>
        <div className='the-f2e-qa-footer'>
          <div className='the-f2e-qa-footer-pillar'></div>
          <div className='the-f2e-qa-footer-bottom'></div>
        </div>
      </div>
      <div className='the-f2e-qa-bulb'>
        <Bulb2 />
      </div>
    </div>
  )
